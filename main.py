...
def classify_type():
    try:
        ...
        return render_template('result.html', variety=variety[0],proba0=variety[1][0],proba1=variety[1][1],proba2=variety[1][2],slen=sepal_len,swid=sepal_wid,plen=petal_len,pwid=petal_wid)
    except:
        return 'Error'
